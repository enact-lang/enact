...
namespace enact {
    ...
    std::pair<std::string, size_t> Chunk::disassembleClosure(size_t index, bool isLong) const {
        ...
        s << std::left << std::setw(MAX_INSTRUCTION_NAME_LENGTH) << std::setfill(' ')
          << opCodeToString(static_cast<OpCode>(m_code[index]));
        s.flags(f);
    ...
    std::string opCodeToString(OpCode code) {
        switch (code) {
            ...
            case OpCode::CHECK_INDEXABLE:
                return "CHECK_INDEXABLE";
            case OpCode::CHECK_ALLOTABLE:
                return "CHECK_ALLOTABLE";
            case OpCode::CHECK_TYPE:
                return "CHECK_TYPE";
            case OpCode::CHECK_TYPE_LONG:
                return "CHECK_TYPE_LONG";
            case OpCode::NEGATE:
                return "NEGATE";
            case OpCode::NOT:
                return "NOT";
            ...
            case OpCode::GET_LOCAL:
                return "GET_LOCAL";
            case OpCode::GET_LOCAL_LONG:
                return "GET_LOCAL_LONG";
            case OpCode::SET_LOCAL:
                return "SET_LOCAL";
            case OpCode::SET_LOCAL_LONG:
                return "SET_LOCAL_LONG";
            case OpCode::GET_UPVALUE:
                return "GET_UPVALUE";
            case OpCode::GET_UPVALUE_LONG:
                return "GET_UPVALUE_LONG";
            case OpCode::SET_UPVALUE:
                return "SET_UPVALUE";
            case OpCode::SET_UPVALUE_LONG:
                return "SET_UPVALUE_LONG";
            case OpCode::GET_FIELD:
                return "GET_FIELD";
            case OpCode::GET_FIELD_LONG:
            ...
            case OpCode::SET_FIELD:
                return "SET_FIELD";
            case OpCode::SET_FIELD_LONG:
                return "SET_FIELD_LONG";
            case OpCode::GET_METHOD:
                return "GET_METHOD";
            case OpCode::GET_METHOD_LONG:
                return "GET_METHOD_LONG";
            case OpCode::GET_ASSOC:
                return "GET_ASSOC";
            case OpCode::GET_ASSOC_LONG:
                return "GET_ASSOC_LONG";
            case OpCode::GET_PROPERTY_DYNAMIC:
                return "GET_PROPERTY_DYNAMIC";
            case OpCode::GET_PROPERTY_DYNAMIC_LONG:
                return "GET_PROPERTY_DYNAMIC_LONG";
            case OpCode::SET_PROPERTY_DYNAMIC:
                return "SET_PROPERTY_DYNAMIC";
            case OpCode::SET_PROPERTY_DYNAMIC_LONG:
                return "SET_PROPERTY_DYNAMIC_LONG";
            case OpCode::JUMP:
                return "JUMP";
            case OpCode::JUMP_IF_TRUE:
                return "JUMP_IF_TRUE";
